...
- (void)_setupConstraints
{
    ...
    //orderTitleLabel
//    NSLayoutConstraint *orderTitleMarginTopConstraint = [NSLayoutConstraint constraintWithItem:self.orderTitleLabel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:5];
//    
...
//    
//    //titlelabel
//    NSLayoutConstraint *titleMarginTopConstraint = [NSLayoutConstraint constraintWithItem:self.trackTitleLabel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.orderTitleLabel attribute:NSLayoutAttributeBottom multiplier:1.0 constant:5];
//    
...
//    
//    NSLayoutConstraint *trackImageHeightConstraint = [NSLayoutConstraint constraintWithItem:self.trackImage attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:56];
//    
//    NSLayoutConstraint *trackImageWidthConstraint = [NSLayoutConstraint constraintWithItem:self.trackImage attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:56];
//    
...
//    
//    NSLayoutConstraint *descLabelTopConstraint = [NSLayoutConstraint constraintWithItem:self.trackDescLabel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.trackImage attribute:NSLayoutAttributeTop multiplier:1.0 constant:0];
//    
...
//    
//    NSLayoutConstraint *priceLabelTopConstraint = [NSLayoutConstraint constraintWithItem:self.priceLabel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.trackDescLabel attribute:NSLayoutAttributeBottom multiplier:1.0 constant:10];
//    
...
//    [self.superview addConstraint:backImageConstraint];
    ...
    self.orderTitleLabel.frame = CGRectMake(6, 5, 200, 20);
    self.trackTitleLabel.frame = CGRectMake(6, 25, 200, 20);
    self.trackImage.frame = CGRectMake(6, /*CGRectGetMaxY(self.bubbleView.trackTitleLabel.frame)*/45 + 5, 56, 56);
    self.trackDescLabel.frame = CGRectMake(CGRectGetMaxX(self.trackImage.frame) + 5, CGRectGetMaxY(self.trackTitleLabel.frame) + 5, 120, 35);
    self.trackDescLabel.numberOfLines = 2;
    self.priceLabel.frame = CGRectMake(CGRectGetMaxX(self.trackImage.frame) + 5, CGRectGetMaxY(self.trackDescLabel.frame), 120, 15);
